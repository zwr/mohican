angular.module('mnOldDirectives', []).directive('mnNavbar', function() {
  ...
  return ret = {
    restrict: 'E',
    transclude: true,
    template: '<div class=mn-navbar-title navbar-header pull-left"><a class="navbar-brand" href="/#/"><img height="45px" src="assets/mohicanUI_logoB.jpg"/><span ng-transclude></span></a></div>'
  };
